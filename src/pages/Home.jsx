...
const Home = () => {
  ...
  return (
    <div className="bg-bg text-text font-dm selection:bg-accent/30">
      ...
      {/* Nav */}
      <nav className="fixed top-0 left-0 right-0 z-[100] px-[6vw] py-[18px] flex items-center justify-between bg-bg/85 backdrop-blur-[18px] border-b border-border">
      ...
      {/* About Section */}
      <section id="about" className="bg-bg2 py-[70px] px-[6vw]">
      ...
      {/* Education Section */}
      <section id="education" className="bg-bg py-[70px] px-[6vw]">
      ...
      {/* Portfolio Section */}
      <section id="portfolio" className="bg-bg2 py-[70px] px-[6vw]">
      ...
      {/* Contact Section */}
      <section id="contact" className="bg-bg py-[70px] px-[6vw]">
      ...
      <footer className="bg-bg2 border-t border-border px-[6vw] py-9 flex flex-col sm:flex-row items-center justify-between flex-wrap gap-5 text-center sm:text-left">
